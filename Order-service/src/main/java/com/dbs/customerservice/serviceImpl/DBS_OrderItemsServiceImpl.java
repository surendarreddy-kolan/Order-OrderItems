package com.dbs.customerservice.serviceImpl;
...
import com.dbs.customerservice.dao.DBS_OrderItemsDAO;
import com.dbs.customerservice.service.DBS_OrdersItemsService;
...
public class DBS_OrderItemsServiceImpl implements DBS_OrdersItemsService{
	...
	@Override
	public DBS_OrderItemsVO createOrderItems(DBS_OrderItemsVO orderItemsVO) {
	...
	@Override
	public DBS_OrderItemsVO geOrderItemsByOrderId(Long orderId) throws DBS_RecordNotFoundException {
		Optional<DBS_OrderItemsEntity> orderItemsEntity = orderItemsDAO.findById(orderId);
		 if(orderItemsEntity.isPresent()) {
			 DBS_OrderItemsVO orderItemsVO = convertEntity2VO(orderItemsEntity.get());
	            return orderItemsVO;
	        } else {
	            throw new DBS_RecordNotFoundException("No Order Items available with Order Id "+orderId);
	        }
	}
